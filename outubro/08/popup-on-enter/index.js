 ...
 function appendWarningPopup(popupData, url) {
  ...
  if(window.location.href.endsWith('/') || window.location.href.endsWith('.com') || window.location.href.endsWith('.com.br') || window.location.href.endsWith(endOfURL) ) {
    ...
    const buildPopupCode = ({ title, content, buttonText, buttonLink }) => {
      ...
      <div class="on-enter-popup-fancybox">
        <div class="popup-wrapper">
          <div class="popup-content">
            ...
            ${buttonText ? '<a class="btn btn-popup-in" href="' + buttonLink + '">' + buttonText + '</a>' : ''}
          </div>
...
const popupData = { 
  ...
  buttonLink: '#',
  finalDate: new Date(2020, 9, 24, 9, 51, 0, 0)
}

appendWarningPopup(popupData, 'ford-ebd-teste')