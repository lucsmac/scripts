(() => {
  ...
  addStyle({
    styles: `
    header #top-logo-fixed .container {
      position: initial;
      display: grid;
    ...
    header #top-logo-fixed .container > a:first-child {
      grid-column: 2;
      justify-self: center;
    }

    header #top-logo-fixed .container  .header__networks {
      justify-self: end;
    }

    header #top-logo-fixed .container  .header__networks .header__networks-list {
      background-color: transparent;
      padding: 0;
      border-radius: 0;
    }

    header #top-logo-fixed .container  .header__networks .header__networks-list > a + a {
      margin-left: 5px
    }
