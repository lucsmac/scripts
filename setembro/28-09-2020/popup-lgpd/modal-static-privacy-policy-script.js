...
<div class="policy-wrapper">
  <div class="policy-content">
    ...
    <main class="privacy-policy__content">
      ...
      <p>No entanto, embora trabalhemos com boas práticas de proteção e segurança, nenhum serviço web possui 100% de garantia contra invasões e não podemos nos responsabilizar caso isso ocorra.<
...
const changeContent = () => {
  ...
  const target = document.querySelector('.pop-up-wrapper-item')
  ...
  addStyle({
    ...
    .privacy-policy__to-top a {
      font-size: 12px;
    }
    .privacy-policy__to-top icon {
      font-size: 12px;
    }

    h2.privacy-policy-subtitle {
      font-size: 1.3rem;
    }
    ...
    .policy-content ol.privacy-policy__list {
      font-size: 1.2rem;
    }
  ...
  injectValues({
    name: 'Bexp',
    adress: 'Av. Morumbi, 7625 - Esquina com a Av. Chucri Zaidan - Brooklin - São Paulo-SP',
    phone: '(11) 5102-5555'
  })
}
